...
public class SimplePlayEngine {
  ...
  func initComponent(
    ...
    AVAudioUnit.instantiate(
      ...
      print(
        "responds(to: speechVoices): \(audioUnit.auAudioUnit.responds(to: #selector(getter: AVSpeechSynthesisProviderAudioUnit.speechVoices)))"
      )
      print(
        "responds(to: synthesizeSpeechRequest): \(audioUnit.auAudioUnit.responds(to: #selector(AVSpeechSynthesisProviderAudioUnit.synthesizeSpeechRequest(_:))))"
      )
      if audioUnit.auAudioUnit.responds(
        to: #selector(getter:AVSpeechSynthesisProviderAudioUnit.speechVoices))
      {
        print(
          "speechVoices: \(String(describing: audioUnit.auAudioUnit.perform(#selector(getter: AVSpeechSynthesisProviderAudioUnit.speechVoices))))"
        )
      }
      //            print("speechVoices: \(String(describing: audioUnit.auAudioUnit.perform(#selector(getter: AVSpeechSynthesisProviderAudioUnit.speechVoices))))")
